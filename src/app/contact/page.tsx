          ...
          <div className="contact-card-dark">
            ...
            <div className="contact-right-form">
              ...
              <div className="social-circles">
                <a href="https://www.linkedin.com/in/anmol-malviya27?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" className="social-circle linkedin" aria-label="LinkedIn">
