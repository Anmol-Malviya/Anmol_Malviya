        ...
        <section className="contact trail-container">
            ...
            <div className="contact-left-impressive">
              <div className="impressive-text">
                <h3>Let&apos;s create</h3>
                <h1 className="glitch-text" data-text="Something">Something</h1>
                <h1 className="gradient-text">Extraordinary.</h1>
              </div>
            ...
            <div className="contact-right-form">
              ...
              <form className="contact-form-ui" id="contactForm">
                ...
                <button type="submit" className="submit-btn" style={{position: 'relative'}}>
                  <span>Submit ➔</span>
                </button>
                <div className="success-message" id="successMessage" style={{marginTop:'0.5em', opacity: 0, transition: '0.3s', color:'#a0a5b1', fontFamily:'sans-serif', textAlign:'center'}}>
              ...
              <div className="social-circles">
                <a href="https://www.linkedin.com/in/anmol-malviya27?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" className="social-circle linkedin">
                ...
                <a href="https://www.instagram.com/anmol_20_7_?igsh=MWhyOXdnNGJqcGQwNg==" target="_blank" rel="noreferrer" className="social-circle instagram">
                ...
                <a href="https://wa.me/917987837169" target="_blank" rel="noreferrer" className="social-circle whatsapp">
